...
#
################################################################################
class apache2::mod::mem_cache ( $activated=true, $size=4096, $max_object_count=1009, $min_object_size=1, $max_object_size=10000, $removal_algorithm="GDSF" ) {
    ...
    apache2::module { "mem_cache":
        ...
        require             => [ Package [ "httpd" ], Class [ "apache2::mod::cache" ] ],
    }
}